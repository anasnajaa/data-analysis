...
const {a2_q2} = require('../answers/a2_q2');
...
const {b2_q7} = require('../answers/b2_q7');
...
router.get("/a2_q2", async (req, res, next) => {
    const data = await a2_q2();
    res.render('pages/a2_q2', { data });
});

router.get("/a2_q3", async (req, res, next) => {
    const data = await a2_q3();
    res.render('pages/a2_q3', { data });
});
...
router.get("/b2_q7", async (req, res, next) => {
    const data = await b2_q7();
    res.render('pages/b2_q7', { data });
});
